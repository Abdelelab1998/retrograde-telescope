...
export default function App() {
  ...
  return (
    <div className={`fixed inset-0 w-full h-full overflow-hidden antialiased ${theme === 'dark' ? 'bg-[#0a0a0a] text-white' : 'bg-gray-50 text-gray-900'}`} style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
